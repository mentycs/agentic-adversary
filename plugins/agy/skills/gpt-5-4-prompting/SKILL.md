...
description: Internal guidance for composing Antigravity and Gemini prompts for coding, review, diagnosis, and research tasks inside the Antigravity Claude Code plugin
user-invocable: false
---

# GPT-5.4 Prompting

Use this skill when `agy:agy-rescue` needs to ask Antigravity or another Gemini-based workflow for help.
...
- Use `task --resume-last` for follow-up instructions on the same Antigravity thread. Send only the delta instruction instead of restating the whole prompt unless the direction changed materially.
