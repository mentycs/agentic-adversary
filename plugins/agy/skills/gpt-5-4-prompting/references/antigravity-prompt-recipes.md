...
Use these as starting templates for Antigravity task prompts or other Antigravity/Gemini prompt construction.
...
```xml
<task>
Diagnose why this existing prompt is underperforming and propose the smallest high-leverage changes to improve it for Antigravity or Gemini.
</task>
